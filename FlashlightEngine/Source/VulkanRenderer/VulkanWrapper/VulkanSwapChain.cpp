...
namespace VulkanWrapper
{
    ...
    void VulkanSwapChain::CreateSwapChain() {
        VulkanBase::SwapChainSupportDetails swapChainSupport = m_VulkanBase.GetSwapChainSupportDetails();
        ...
        VulkanBase::QueueFamilyIndices indices = m_VulkanBase.GetQueueFamilies();
    ...
    void VulkanSwapChain::CreateImageViews() {
        ...
        for (size_t i = 0; i < m_Vulkan.SwapChainImages.size(); i++) {
            ...
            if (vkCreateImageView(m_VulkanBase.Device(), &createInfo, nullptr, &m_Vulkan.SwapChainImageViews[i]) != VK_SUCCESS) {
    ...
    void VulkanSwapChain::DestroyImageViews() const {
        for (const auto imageView : m_Vulkan.SwapChainImageViews) {
