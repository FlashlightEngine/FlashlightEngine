...
namespace Flashlight::VulkanWrapper {
    GraphicsPipeline::GraphicsPipeline(Device& device, const VkPipeline& pipeline,
                                       const VkPipelineLayout& pipelineLayout) : m_Pipeline(pipeline),
                                                                                 m_PipelineLayout(pipelineLayout),
                                                                                 m_Device(device) {
    }

    void GraphicsPipeline::Builder::VertexShader(ShaderModule& shaderModule) {
        m_VertexShaderModule = &shaderModule;
    }

    void GraphicsPipeline::Builder::FragmentShader(ShaderModule& shaderModule) {
