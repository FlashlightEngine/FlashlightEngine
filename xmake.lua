...
option("usepch", {description = "Use precompiled header (speeds up compilation.)", default = false})
...
target("FlashlightEngine")
	...
	add_packages("spdlog", "vk-bootstrap", "vulkan-memory-allocator", "stb", "flutils")
